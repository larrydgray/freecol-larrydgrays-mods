...
- **Eat the horses** - ties into the existing End-Turn Starvation
  Warning: if a colony would actually lose a colonist this turn AND
  horses are available there (warehouse stock, or a dragoon currently
